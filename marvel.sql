...
SELECT * FROM people;
-- 8.  The cinema has just heard that they will be holding an exclusive midnight
-- 		showing of 'Avengers: Infinity War'!! Create a new entry in the 'movies' table to reflect this.
INSERT INTO movies (title) VALUES ('Avengers: Infinity War');
SELECT * FROM movies;
-- 9.  The cinema would like to make the Iron Man movies a triple billing.
...
--   delete Itchy & Scratchy from people
